...
export default class DhiegoLevel2 extends BaseLevel {
  ...
  preload() {
    this.load.tilemapCSV("dhiegomap2", "src/scenes/screens/Levels/DhiegoLevel/csv/dhiego_level_4.csv");
    this.load.tilemapCSV("dhiegobg2", "src/scenes/screens/Levels/DhiegoLevel/csv/dhiego_level_v2_bg.csv");
  }

  create() {
    // ------------------------------------------------- //
    bg_map = this.make.tilemap({ key: "dhiegobg2", tileWidth: 16, tileHeight: 16 });
    bg_tileset = bg_map.addTilesetImage("Textures.simple");
    bg_layer = bg_map.createLayer(0, bg_tileset, 0, 0);

    map = this.make.tilemap({ key: "dhiegomap2", tileWidth: 16, tileHeight: 16 });
    ...
    [
      { pos: 216, enemy: Bee, scale: 0.5 },
      { pos: 137, enemy: Bee, scale: 0.5 },
      { pos: 23, enemy: Dog, scale: 1 },
      { pos: 295, enemy: Dog, scale: 1 },
